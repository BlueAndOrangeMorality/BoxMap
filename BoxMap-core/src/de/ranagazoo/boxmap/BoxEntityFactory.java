...
public class BoxEntityFactory implements Disposable
{
  ...
  public String getType(MapObject mapObject)
  {
    return mapObject.getProperties().get("type", String.class);
  }
  
  public Vector2 getPosition(MapObject mapObject)
  {
  ...
  public Shape getShape(MapObject mapObject)
  {
...
//    else if (mapObject.getClass().equals(TiledMapTileMapObject.class))
  ...
  public BodyDef getBodyDef(String type)
  {
  ...
  public FixtureDef getFixtureDef(String type)
  {
    if(type.equals(Config.TYPE_PLAYER1))
